...
-- Create ActorMovies junction table
...
-- Insert Actor data into Actors table
...
-- Insert quote data into Quotes table
...
('If we burn, you burn with us!', 5, 21, NULL),
...
('By all means, move at a glacial pace', 12, 50, "https://www.youtube.com/watch?v=Bmlu26h9H8M&list=RDBmlu26h9H8M&start_radio=1"),
...
('But now, misery has come home, and men appear to me as monsters, thirsting for each other\'s blood.', 16, 71, NULL),
('You talkin\' to me?', 17, 74, 'https://www.youtube.com/watch?v=-QWL-FwX4t4');

-- Insert hint data into the Hint table
...
-- Insert actor id's along with the film's they were in, into the ActorMovies junction table
...
-- An optional select statement that allows any inaccuracies with the data to be easily visible
SELECT a.actor_id, a.actor_name, m.movie_id, m.movie_name, m.movie_id
FROM Actors a 
